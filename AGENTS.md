...
This package implements the WebMCP Community Group draft. Aim to support the full
API; track missing behavior as implementation work. Use the official `webmcp-types`
dependency; do not duplicate its declarations. Document browser restrictions with
evidence for the affected behavior.
No MCP server, MCP transport, extension product, navigator aliases, or legacy API
...
3. Check browser evidence using the sources listed in TESTING.md. A Chromium test,
